package com.tsuchinoko.t2s.core.designsystem.component
...
/**
 * link: https://rrohaill.medium.com/deprecated-accompanist-modifier-placeholder-shimmer-loading-solution-db4ce5e5e8dd

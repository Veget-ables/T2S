...
- start: <予定の開始日時>
- end: <予定の終了日時>
- baseTitle:<予定フォーマットの「title」を決定する証拠となった元のテキスト>
- baseDate:<予定フォーマットの「start」を決定する証拠となった元のテキスト>
...
・「title」のルール
　・予定のタイトルを入力する
　・予定のタイトルの元になったテキストの内「タイトルを象徴する絵文字」のみを省略する。それ以外は編集せずにそのまま入力する
・「memo」のルール
　・時間帯に応じた行動リストを入力する
　・何もなければ、"メモなし"を入力する
・「start」と「end」のルール
...
　　　・11:55-13:55 生放送
・「baseTitle」のルール
　・予定フォーマットの「title」を決定する証拠となった元のタイトル情報のテキストを入力する
・「baseDate」のルール
　・予定フォーマットの「start」を決定する証拠となった元の日付情報のテキストを入力する
